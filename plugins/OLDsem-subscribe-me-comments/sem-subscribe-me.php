<?php
/*
Plugin Name: Subscribe Me (modifisert)
Plugin URI: http://dss.dep.no/software/subscribe-me/
Description: Widgets that let you display subscribe links to RSS readers such as Google Reader. (<b>Modifisert til å bruke comments feed</b>)
Version: 5.0.2
...
class subscribe_me extends WP_Widget {
	...
	function widget($args, $instance) {
		...
		$feed_url = user_trailingslashit(apply_filters('bloginfo', get_feed_link('comments_rss2'), ''));
