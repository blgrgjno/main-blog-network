...
Get email notifications for comments on other authors' posts. Activation/subscription-free fork of MaxBlogPress Multi Author Comment Notification
...
2. From your Admin UI (Dashboard), use the menu to select Options -> cbnet Multi Author Comment Notification 
