 ...
 */
class samarbeidPostRankDaemon extends nm_daemon {
    ...
    public function __construct($unique_name) {
        ...
        // Set up daemon config

        if (isset($this->_settings["daemon_username"])) {

            $this->_daemon_username = $this->_settings["daemon_username"];
        }

        if (isset($this->_settings["daemon_group"])) {

            $this->_daemon_group = $this->_settings["daemon_group"];
        }

        if (isset($this->_settings["sleep_period"])) {

            $this->sleep_period = $this->_settings["sleep_period"];
        }
        ...
        parent::__construct($unique_name);
    }
