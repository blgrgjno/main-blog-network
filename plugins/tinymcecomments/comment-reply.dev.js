addComment = {
	...
	rmTiny : function() {
		try {
			...
			tinyMCE.execCommand('mceRemoveControl', false, 'comment_where');
			tinyMCE.execCommand('mceRemoveControl', false, 'comment_how');
	...
	addTiny : function() {
		try {
			...
			tinyMCE.execCommand('mceAddControl', false, 'comment_where');
			tinyMCE.execCommand('mceAddControl', false, 'comment_how');
