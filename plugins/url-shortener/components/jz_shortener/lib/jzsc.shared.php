<?php
/*
 * JZSCLib Name:		jzsc.shared - Shared JZ Shortener Components
 * JZSCLib Description: This class contains the request gateway for shortening
 ...
 */
        ...
        public function __construct() {
            $this->jzsc_shared($status);
        }
       
        //backward compatibility
        public function jzsc_shared($status){
			$this->status = $status;         
        }
