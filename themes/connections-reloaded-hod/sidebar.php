...
<?php if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar() ) { ?>
	...
	<li id="categories">
		<h2><?php _e('Categories:', 'dss-loaded'); ?></h2>
		<ul>
	...
	<li id="tags">
		<h2><?php _e('Popular Tags:', 'dss-loaded'); ?></h2>
	...
	<li id="subscriptions">
		<h2><?php _e('Subscriptions:', 'dss-loaded'); ?></h2>
		<ul>
			<li><a href="<?php bloginfo('rss2_url'); ?>" title="<?php _e('Syndicate this site using RSS', 'dss-loaded'); ?>"><img src="<?php bloginfo('template_directory'); ?>/img/add-rss2.0.png" alt="<?php _e('Syndicate this site using RSS', 'dss-loaded'); ?>" width="80" height="15" /></a></li>
		    <li><a href="<?php bloginfo('comments_rss2_url'); ?>" title="<?php _e('The latest comments to all posts in RSS', 'dss-loaded'); ?>"><img src="<?php bloginfo('template_directory'); ?>/img/comments-rss.png" alt="<?php _e('The latest comments to all posts in RSS', 'dss-loaded'); ?>" width="80" height="15" /></a></li>
