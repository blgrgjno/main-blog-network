...
<div class="wrap">
<h2><?php echo $themename;  _e(' Settings', 'dss-loaded') ?></h2>
...
<span class="title"><?php _e('Quick links', 'dss-loaded') ?></span>				
<ul>
	<li><a href="http://ajaydsouza.com/wordpress/wpthemes/connections-reloaded/"><?php _e('Connections Reloaded page', 'dss-loaded') ?></a></li>
	<li><a href="http://ajaydsouza.org"><?php _e('Support forum', 'dss-loaded') ?></a></li>
</ul>
</div>
<div class="side-widget">
<span class="title"><?php _e('Connections Reloaded recent developments', 'dss-loaded') ?></span>				
...
<div class="side-widget">
<span class="title"><?php _e('Support the development', 'dss-loaded') ?></span>
<div id="donate-form">
...
<strong><?php _e('Enter amount in USD: ', 'dss-loaded') ?></strong> <input name="amount" value="10.00" size="6" type="text"><br />
