...
*/
		?>
		<b>Ansvarlig redaktør</b>: <a href="mailto:kommunikasjonsenheten@mfa.no">Ragnhild Imerslund</a> <b>Nettredaktør</b>: <a href="mailto:jtj@mfa.no">Johan T. Jensen</a>.<br />		<a href="<?php bloginfo('url'); ?>" title="<?php bloginfo('name'); ?>"><?php 
...
?></a> kjører <a href="http://wordpress.org">WordPress</a> og bygger på <a href="http://ajaydsouza.com/wordpress/wpthemes/connections-reloaded/" title="Powered by Connections Reloaded">Connections Reloaded</a>.
		<br/>
		<a href="http://ud.dep.no">Utenriksdepartementet</a>
	</small></p>
