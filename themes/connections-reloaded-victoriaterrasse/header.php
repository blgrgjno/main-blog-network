...
?><ul id="topnav">
	  ...
	  <li><a href="http://blogg.regjeringen.no/norgeiverden" alt="Tilbake til Norge i verden">Norge i verden</a></li>

	  <li><a href="http://blogg.regjeringen.no/norgeiverden/om" alt="Beskrivelse av Norge i Verden">Om bloggene</a></li>
	</ul>
<?php
}
/*wp_nav_menu( array(
