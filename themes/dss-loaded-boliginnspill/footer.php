...
*/
		?>
		<b>Ansvarlig redaktør</b>: <a href="mailto:liv-merete.wiker@krd.dep.no">Liv Merete Wiker</a> <b>Nettredaktør</b>: <a href="mailto:eline.bjerke@krd.dep.no">Eline Bjerke</a>.<br />		<a href="<?php bloginfo('url'); ?>" title="<?php bloginfo('name'); ?>"><?php 
...
?></a> kjører <a href="http://wordpress.org">WordPress</a> og bygger på <a href="http://ajaydsouza.com/wordpress/wpthemes/connections-reloaded/" title="Powered by Connections Reloaded">Connections Reloaded</a>.
		<br/>
		<a href="http://krd.dep.no">Kommunal- og regionaldepartementet</a>
	</small></p>
