...
?>
	  ...
	  <a href="/fiks"><img id="headimg" src="http://blogg.regjeringen.no/fiks/wp-content/themes/dss-loaded-fiks/img/header_default.jpg" alt="Fornyings- admininstrajons- og kirkedepartementet"></img></a>
<!--	<div id="headimg">

	  <div id="desc"><a href="<?php bloginfo('url'); ?>"><?php bloginfo('description');?></a></div>
