...
*/
		?>
<b>Nettredaktør</b>: <a href="mailto:halvard.wensel@fkd.dep.no">Halvard Wensel</a>		<b>Ansvarlig redaktør</b>: <a href="mailto:anne-berit.herstad@fkd.dep.no">Anne-Berit Herstad</a> .

<br />		<a href="<?php bloginfo('url'); ?>" title="<?php bloginfo('name'); ?>"><?php 
...
?></a> kjører <a href="http://wordpress.org">WordPress</a> og bygger på <a href="http://ajaydsouza.com/wordpress/wpthemes/connections-reloaded/" title="Powered by Connections Reloaded">Connections Reloaded</a>.
		<br/>
		<a href="http://fkd.dep.no">Fiskeri- og kystdepartementet</a>
	</small></p>
