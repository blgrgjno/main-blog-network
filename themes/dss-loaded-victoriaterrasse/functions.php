...
function dss_init()
{
  ...
  wp_enqueue_script( 'enchant' , '/wp-content/themes/dss-loaded/enchant.js' );

  $data = array('home_url' => get_home_url());

  wp_localize_script( 'enchant', 'EnchantData', $data);
  //remove_action('wp_head', 'header_style');
}

add_action( 'init', 'dss_init' );
