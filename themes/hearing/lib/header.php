...
?>
	...
	<div class="exit_logo">
		<a href="<?php theme_option('exit_url'); ?>" target="_blank"><img src="<?php bloginfo('stylesheet_directory'); ?>/img/logo_exit.png" alt="<?php theme_option('exit_title'); ?>" title="Gå til <?php theme_option('exit_title'); ?>" /></a>
	</div>
	<?php if (!is_front_page()) { ?>
	<div class="front_link"><a href="<?php bloginfo('url') ?>/" title="Gå til forsiden">Til forsiden</a></div>
	<?php } ?>
<?php
}
