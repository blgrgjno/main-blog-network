...
?>
	<div class="hod_logo">
		<a href="<?php theme_option('exit_url'); ?>" target="_blank"><img src="<?php bloginfo('stylesheet_directory'); ?>/img/logoHodSmall.png" alt="Helse- og omsorgsdepartementet"/></a>
	</div>
<?php
}
...
function getAuthorMeta($simple = false) {
	...
	$curauth = get_userdatabylogin(esc_attr( $_GET['author_name'] ) ); // Added esc_attr() here in case get_userdatabylogin doesn't handle sanitisation - added quickly during security audit in November 2012
	else :
	...
	$meta_author .= sprintf('<span class="author_name author_%4$s"><a href="%1$s" title="%2$s">%3$s</a></span>',
