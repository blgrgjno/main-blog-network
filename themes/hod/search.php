	...
	<div id="container">
		<div id="content">
            ...
            if (have_posts()) {
				...
				$content .= ' &ldquo;';
				$content .= esc_html( $_GET['s'] ); // Changed to esc_html() due to concern over previous method of sanitisation
				$content .= '&rdquo;';
			...
			<div id="post-0" class="post noresults">
				...
				<form id="noresults-searchform" method="get" action="<?php bloginfo('home') ?>">
					<div>
						<input id="noresults-s" name="s" type="text" value="<?php echo esc_attr( $_GET['s'] ); ?>" size="40" />
