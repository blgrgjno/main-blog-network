...
/*
	...
	From the multiple post thumbnails plugin: http://wordpress.org/extend/plugins/multiple-post-thumbnails/
...
if (!class_exists('MultiPostThumbnails')) {
	...
	class MultiPostThumbnails {
		...
		public function enqueue_admin_scripts() {
			wp_enqueue_script( 'featured-image-custom', get_template_directory_uri() . '/scripts/multi-post-thumbnails-admin.js', array( 'jquery' ) );
		}
